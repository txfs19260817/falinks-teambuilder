        ...
        <div className="card my-3 w-full max-w-sm flex-shrink-0 bg-base-100 shadow-2xl">
          ...
          >
            ...
            <div className="form-control">
              ...
              <textarea
                id="paste"
                className={`textarea textarea-bordered text-base-content ${errors.paste ? 'textarea-error' : ''}`}
            ...
            <div className="form-control">
              ...
              <textarea id="notes" className="textarea textarea-bordered" placeholder={t('create.form.notes.placeholder')} rows={3} {...register('notes')} />
            </div>
            <div className="form-control">
              <label className="label cursor-pointer">
                <span className="label-text">🔐{t('create.form.public.private')}</span>
                <input type="checkbox" className="toggle toggle-secondary" {...register('isPublic')} />
            ...
            <div className="form-control mt-6">
              <button className="btn btn-primary">{t('create.form.submit.button')}</button>
            </div>
          </form>
        </div>
      </div>
